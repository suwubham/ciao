  ...
  return (
    <nav className="navbar navbar-custom sticky-top navbar-expand-lg " style={{ postion: "fixed" }} >
      <div className="container-fluid">
        <a className="navbar-title navbar-custom" onClick={()=>navigate('/home')}><img src={Logo} height={30} width={75} /></a>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <a className="nav-link navbar-custom" aria-current="page" onClick={()=>navigate('/about')}>About</a>
            </li>
            <li className="nav-item">
              <a className="nav-link navbar-custom" onClick={()=>navigate('/yourarts')}>Your Arts </a>
            </li>
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu navbar-custom">
                <li><a className="dropdown-item navbar-custom" onClick={()=>navigate('/template')}>From Template</a></li>
          ...
          <ul className="navbar-nav">
            <li className="nav-item">
              <a className="nav-link navbar-custom" id="Profile-btn" onClick={()=>navigate('/profile')}>Profile</a>
            </li>
          </ul>
        </div>
      </div>
