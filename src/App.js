...
function App() {
  return (
    <>
      ...
      <navbar
        class="navbar sticky-top navbar-expand-lg bg-secondary"
        style={{ postion: "fixed" }}
      >
        <div class="container-fluid">
          <a class="navbar-title" href="http://localhost:3000/home">
            CIAO
          </a>
          <button
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="http://localhost:3000/blogs">
                  Blogs{" "}
                </a>
              </li>
